...
send("set -g ghoti_key_bindings ghoti_vi_key_bindings\r")
expect_prompt()

send("echo ready to go\r")
expect_prompt("\r\nready to go\r\n")
send(
    "function add_change --on-variable ghoti_bind_mode ; set -g MODE_CHANGES $MODE_CHANGES $ghoti_bind_mode ; end\r"
)
expect_prompt()
