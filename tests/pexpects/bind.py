...
# ghoti should start in default-mode (i.e., emacs) bindings. The default escape
# timeout is 30ms.
...
send("set -g ghoti_escape_delay_ms 200\r")
expect_prompt()
...
expect_prompt(
    "\r\nghoti_escape_delay_ms=200\r\n",
    unmatched="default-mode custom timeout not set correctly",
)

# Set it to 100ms.
sendline("set -g ghoti_escape_delay_ms 100")
expect_prompt()
