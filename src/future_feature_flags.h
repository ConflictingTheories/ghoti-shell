...
inline const features_t &ghoti_features() { return features_t::global_features; }

/// Perform a feature test on the global set of features.
inline bool feature_test(features_t::flag_t f) { return ghoti_features().test(f); }

/// Return the global set of features for ghoti, but mutable. In general ghoti features should be set
/// at startup only.
inline features_t &mutable_ghoti_features() { return features_t::global_features; }
