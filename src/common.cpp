...
/// characters reserved by PCRE2 are escaped, i.e. it relies on ghoti's automatic escaping
...
/// Test if the specified character is in a range that ghoti uses interally to store special tokens.
///
