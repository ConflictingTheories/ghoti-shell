...
///   1. A parser. This is often null. If not null, it may be used to execute ghoti script. If null,
///   then this is a background operation and ghoti script must not be executed.
