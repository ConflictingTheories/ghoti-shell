...
timer_snapshot_t timer_snapshot_t::take() {
    ...
    getrusage(RUSAGE_SELF, &snapshot.cpu_ghoti);
...
wcstring timer_snapshot_t::print_delta(timer_snapshot_t t1, timer_snapshot_t t2,
                                       bool verbose /* = true */) {
    int64_t ghoti_sys_micros = micros(t2.cpu_ghoti.ru_stime) - micros(t1.cpu_ghoti.ru_stime);
    int64_t ghoti_usr_micros = micros(t2.cpu_ghoti.ru_utime) - micros(t1.cpu_ghoti.ru_utime);
    ...
    ghoti_sys_micros = std::max(int64_t(0), ghoti_sys_micros);
    ghoti_usr_micros = std::max(int64_t(0), ghoti_usr_micros);
    child_sys_micros = std::max(int64_t(0), child_sys_micros);
    child_usr_micros = std::max(int64_t(0), child_usr_micros);

    int64_t net_sys_micros = ghoti_sys_micros + child_sys_micros;
    int64_t net_usr_micros = ghoti_usr_micros + child_usr_micros;
    ...
    if (!verbose) {
        ...
        auto ghoti_unit = get_unit(std::max(ghoti_sys_micros, ghoti_usr_micros));
        auto child_unit = get_unit(std::max(child_sys_micros, child_usr_micros));
        auto ghoti_usr_time = convert(ghoti_usr_micros, ghoti_unit);
        auto ghoti_sys_time = convert(ghoti_sys_micros, ghoti_unit);
        ...
        append_format(output,
                      ...
                      strlen(unit_short_name(ghoti_unit)) + 7, "ghoti", "external",            //
                      usr_time, column2_unit_len, unit_short_name(cpu_unit), ghoti_usr_time,  //
                      unit_short_name(ghoti_unit), child_usr_time, unit_short_name(child_unit),
                      sys_time, column2_unit_len, unit_short_name(cpu_unit), ghoti_sys_time,
                      unit_short_name(ghoti_unit), child_sys_time, unit_short_name(child_unit));
    }
