...
///
/// will print the string 'ghoti: Pi = 3.141', given that debug_level is 1 or higher, and that
/// program_name is 'ghoti'.
...
/// The verbosity level of ghoti. If a call to debug has a severity level higher than \c debug_level,
...
#undef assert
#define assert(e) (e) ? ((void)0) : __ghoti_assert(#e, __FILE__, __LINE__, 0)
#define assert_with_errno(e) (e) ? ((void)0) : __ghoti_assert(#e, __FILE__, __LINE__, errno)
