...
class inputter_t {
   ...
   public:
    ...
    ///
    /// The argument determines whether ghoti commands are allowed to be run as bindings. If false,
    /// when a character is encountered that would invoke a ghoti command, it is unread and
