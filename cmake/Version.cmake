# This file adds commands to manage the ghoti-BUILD-VERSION-FILE (hereafter
# FBVF). This file exists in the build directory and is used to populate the
# documentation and also the version string in ghoti_version.o (printed with
# `echo $version` and also ghoti --version). The essential idea is that we are
# going to invoke git_version_gen.sh, which will update the
# ghoti-BUILD-VERSION-FILE only if it needs to change; this is what makes
...
# a dependency of ghoti_version.o, and that git_version_gen.sh updates it. Make
# will then invoke the script, check the timestamp on ghoti_version.o and FBVF,
# see that FBVF is earlier, and then not rebuild ghoti_version.o. Ninja,
...
# meaning that using BYPRODUCTS will cause ghoti_version.o to be rebuilt
...
# generated build systems rebuild ghoti when the git tree goes from dirty to
...
set(FBVF ghoti-BUILD-VERSION-FILE)

# TODO: find a cleaner way to do this.
IF (${CMAKE_GENERATOR} STREQUAL Ninja)
  set(FBVF-OUTPUT ghoti-build-version-witness.txt)
...
add_custom_target(CHECK-ghoti-BUILD-VERSION-FILE
...
add_custom_command(OUTPUT ${FBVF-OUTPUT}
                    DEPENDS CHECK-ghoti-BUILD-VERSION-FILE)

# Abbreviation for the target.
set(CFBVF CHECK-ghoti-BUILD-VERSION-FILE)
