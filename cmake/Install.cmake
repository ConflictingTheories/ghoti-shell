...
add_custom_command(OUTPUT ghoti.pc
    ...
    DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/${FBVF} ${CMAKE_CURRENT_BINARY_DIR}/ghoti.pc.noversion)
...
install(FILES share/lynx.lss DESTINATION ${rel_datadir}/ghoti/)
...
install(FILES ghoti.png DESTINATION ${rel_datadir}/pixmaps)
