...
var color_scheme_ghoti_default = {
    'name': 'ghoti default',
    'colors': [],
    ...
    'ghoti_pager_color_description' : 'B3A06D yellow',
    'ghoti_pager_color_prefix' : 'white --bold --underline',
    'ghoti_pager_color_progress' : 'brwhite --background=cyan',
    'normal' : 'normal',
    'user' : 'brgreen',
    'host' : 'normal',
...
var color_scheme_solarized_light = {
    ...
    ghoti_pager_color_completion: 'green',
    ghoti_pager_color_description: 'B3A06D',
    ghoti_pager_color_prefix: 'cyan --underline',
    ghoti_pager_color_progress: 'brwhite --background=cyan',
...
var color_scheme_solarized_dark = {
    ...
    ghoti_pager_color_completion: 'B3A06D',
    ghoti_pager_color_description: 'B3A06D',
    ghoti_pager_color_prefix: 'cyan --underline',
    ghoti_pager_color_progress: 'brwhite --background=cyan',
