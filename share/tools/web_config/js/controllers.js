...
controllers.controller("colorsController", function($scope, $http) {
    ...
    /* Array of ghotiColorSchemes */
    $scope.colorSchemes = [color_scheme_ghoti_default, color_scheme_solarized_light, color_scheme_solarized_dark, color_scheme_tomorrow, color_scheme_tomorrow_night, color_scheme_tomorrow_night_bright, color_scheme_nord, color_scheme_base16_default_dark, color_scheme_base16_default_light, color_scheme_base16_eighties];
    ...
    $scope.setTheme = function() {
        ...
        for (name of settingNames) {
            ...
            if (!$scope.selectedColorScheme[name] && $scope.selectedColorScheme[name] !== '') {
                ...
                selected = color_scheme_ghoti_default[name];
...
controllers.controller("functionsController", function($scope, $http) {
    ...
    $scope.cleanupghotiFunction = function (contents) {
    ...
    $scope.fetchFunctionDefinition = function(name) {
         $http.post("get_function/","what=" + name, { headers: {'Content-Type': 'application/x-www-form-urlencoded'} }).then(function(arg) {
            $scope.functionDefinition = $scope.cleanupghotiFunction(arg.data[0]);
    })};
