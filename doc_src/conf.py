...
def setup(app):
    ...
    ghoti_indent_lexer = pygments.lexers.load_lexer_from_file(
        os.path.join(this_dir, "ghoti_indent_lexer.py"), lexername="FishIndentLexer"
    )
    lexers["ghoti-docs-samples"] = ghoti_indent_lexer
...
project = "ghoti-shell"
copyright = "2020, ghoti-shell developers"
...
# of _static/ghoti-syntax-style.css
html_theme = "nature"
...
htmlhelp_basename = "ghoti-shelldoc"
...
man_pages = [
    (master_doc, "ghoti-doc", "ghoti-shell Documentation", [author], 1),
    ("tutorial", "ghoti-tutorial", "ghoti-shell tutorial", [author], 1),
    ("CHANGELOG", "ghoti-changelog", "ghoti-shell changelog", [author], 1),
    ("completions", "ghoti-completions", "Writing ghoti completions", [author], 1),
    ("faq", "ghoti-faq", "ghoti-shell faq", [author], 1),
]
