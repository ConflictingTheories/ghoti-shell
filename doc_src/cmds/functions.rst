...
Automatically loaded functions cannot be removed using ``functions -e``. Either remove the definition file or change the $ghoti_function_path variable to remove autoloaded functions.
